...
const workshopServicesByCity: Record<
  string,
...
> = {
  goteborg: [
    {
      title: "Oljeservice",
      description: "Oljeservice på plats hos AK-TUNING Göteborg.",
    },
    {
      title: "Felsökning",
    ...
    {
      title: "Bromsbyte",
      description: "Bromsbyte utfört på verkstaden i Göteborg.",
    },
    {
  ...
  jonkoping: [
    {
      title: "Oljeservice",
      description: "Oljeservice på plats hos AK-TUNING Jönköping.",
    },
    {
      title: "Felsökning",
      description: "Felsökning för att hjälpa dig vidare med din bil.",
    ...
    {
      title: "Bromsbyte",
      description: "Bromsbyte utfört på verkstaden i Jönköping.",
    },
    {
      title: "Montering av avgassystem",
      description: "Montering av avgassystem på plats.",
  ...
  skane: [
    {
      title: "Oljeservice",
      description: "Oljeservice på plats hos AK-TUNING Malmö.",
    },
    {
      title: "Felsökning",
      description: "Felsökning för att hjälpa dig vidare med din bil.",
    ...
    {
      title: "Bromsbyte",
      description: "Bromsbyte utfört på verkstaden i Malmö.",
    },
    {
      title: "Montering av avgassystem",
      description: "Montering av avgassystem på plats.",
  ...
  stockholm: [
    {
      title: "Montering av avgassystem",
      description: "Montering av avgassystem på plats hos AK-TUNING Stockholm.",
    },
  ],
  orebro: [
    {
      title: "Montering av avgassystem",
      description: "Montering av avgassystem på plats hos AK-TUNING Örebro.",
    },
  ],
};
...
export default function MotoroptimeringStation({
  ...
  const stationName = stationNames[stationData.slug] || stationData.city;
  ...
  const workshopServices = workshopServicesByCity[stationData.slug] || [];
            ...
            <div className="mx-auto max-w-7xl">
              ...
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {workshopServices.map((service, index) => (
                  <article key={service.title} className="group rounded-2xl border border-white/10 bg-[#111] p-7 transition duration-300 hover:-translate-y-1 hover:bg-black">
