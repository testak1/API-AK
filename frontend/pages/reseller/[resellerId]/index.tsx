    ...
    return (
      <>
        <div className="w-full max-w-6xl mx-auto px-2 p-4 sm:px-4">
          ...
          {settings.enableLanguageSwitcher && settings.secondaryLanguage && (
            <button
              onClick={() => {
              ...
              title={
                currentLanguage === settings.language
                  ? `Switch to ${settings.secondaryLanguage.toUpperCase()}`
                  : `Switch to ${settings.language.toUpperCase()}`
              }
            >
              <GlobeAltIcon className="h-6 w-6 text-white" />
              <span className="text-white font-medium">
                {currentLanguage === settings.language
                  ? settings.secondaryLanguage.toUpperCase()
                              ...
                              {expandedAktPlus[stage.name] && (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                  {allOptions.map(option => {
                                    ...
                                    const title =
                                      override?.title || option.title;
                                    const description =
                                      override?.description ||
                                      option.description;
                                    const price =
                                      override?.price ?? option.price;
