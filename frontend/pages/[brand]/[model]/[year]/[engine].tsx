...
export default function EnginePage({
  ...
  return (
    <>
      <Head>
        <title>
          {brandData?.name} {modelData?.name} | Performance Tuning
        </title>
        <meta
          name="description"
          content={`${engineData.label} tuning options and specifications`}
        />
      </Head>
                ...
                >
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-gray-600">
                          ...
                          {stage.tunedNm - stage.origNm} Nm increase
                        </p>
                      </div>
                  ...
                  <div className="p-6">
                    ...
                    {activeTab === "options" && (
                      <div className="space-y-4">
                        <p className="text-gray-600">
                          Available options for this stage:
                        </p>
