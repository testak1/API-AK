                        ...
                        {!isDsgStage && (
                          <div className="mt-8 mb-10">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                              ...
                              <button
                                onClick={() => {
                                  if (navigator.share) {
                                    navigator.share({
                                      title: `${brandData.name} ${modelData.name} ${stage.name} Optimering`,
                                      text: `Upptäck ${stage.name} optimering för ${brandData.name} ${modelData.name} med ${stage.tunedHk}HK!`,
                                    ...
                                    setContactModalData({
                                      isOpen: true,
                                      stageOrOption: "Dela denna sida",
                                      link: window.location.href,
                                    });
                                  }
                                }}
                                className="bg-gray-700 hover:bg-gray-600 text-white px-4 py-3 rounded-lg font-medium shadow-lg flex items-center justify-center gap-2 transition-all"
                              >
                                <svg
                                  className="w-5 h-5"
                                  fill="none"
                              ...
                              <div className="flex items-center justify-center space-x-2">
                                ...
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="bg-green-500 hover:bg-green-600 p-3 rounded-lg flex items-center justify-center transition-colors"
                                  aria-label="WhatsApp"
                                >
                                  <svg
                                    className="w-5 h-5 text-white"
                            ...
                            <p className="text-center text-gray-400 mt-4 text-sm">
                              Följ oss för fler tuning tips och erbjudanden
                            </p>
                          </div>
                        )}
